<%@ Page Title="" Language="C#" MasterPageFile="~/Forms/Site/Edicoes/2018/MasterPage2018.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="festivalOrigens.index" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <header class="paraxify">
        <div class="container">
            ...
            <div class="entrace wow fadeInUp" data-wow-delay="0.5s">
                <h1 class="Invisivel">18 a 20 de outubro</h1>
                <h2>Vem aí a segunda edição do festival mais esperado do ano!</h2>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 wow fadeInRight" data-wow-duration="0.8s">
                    ...
                    <p>
                        Entre os dias 18 a 20 de outubro,
                        a segunda edição do Festival de Origens reunirá produtos tipicamente baianos
                        conhecidos como os 4 C da Bahia: cachaça, café, charuto e chocolate. Nas
                        históricas cidades de Cachoeira e São Félix, situadas no Recôncavo da Bahia, os
                        participantes terão a oportunidade de conhecer a cultura, história e cadeia
                        produtiva do tabaco, além de aprender suas melhores harmonizações.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="text-justify">
                        ...
                        <p>
                            Palco de uma história centenária,
                            o Recôncavo da Bahia é também berço do plantio de tabaco no Brasil. Nesse solo
                            rico em cultura e em características físicas, que torna o Charuto Baiano
                            diferente dos demais em qualidade, será celebrado o Festival Origens 2018. Com
                            mais de 450 anos de tradição, o território cuida desde o plantio da semente até
                            o charuto acabado, que é comercializado para várias partes do mundo. A primeira
                            edição do evento foi realizada no final do ano 2017 e recebeu apreciadores de
                            charutos vindos de diferentes estados do país.
                        </p>
                        <p>&nbsp;</p>
                        <p>
                            O festival reunirá outros
                            produtos, tipicamente de origem baiana, que harmonizam com o charuto:
                            chocolate, café e cachaça; conhecidos como os 4 C da Bahia. O principal
                            combustível do encontro é valorizar a história e produção desses símbolos
                            locais. Serão três dias de programação repleta de atividades, que
                            proporcionarão aos visitantes uma viagem na história do tabaco.
                        </p>
                        <p>&nbsp;</p>
                        <p>
                            O charuto produzido em terras
                            baianas detém características únicas, que garantem qualidade para competir com
                            os demais charutos presentes no mercado mundial. Essa qualidade é conquistada
                            por conta de diferentes aspectos peculiares do Recôncavo, em relação ao solo,
                            clima, cultura e história. A união desses elementos aliada à expertise do
                            saber-fazer, são ingredientes para a receita do sucesso.
                        </p>
                        <p>&nbsp;</p>
                        <p>
                            Voltado para os apreciadores de
                            charuto de todo Brasil, o festival oferecerá workshops de harmonização com
                            demais produtos, manifestações culturais, além de visitas às tradicionais
                            fábricas do setor na região. Os visitantes conhecerão a cadeia produtiva do
                            tabaco, que apesar de estar concentrada nos municípios de São Félix e
                            Cachoeira, envolvem 23 municípios vizinhos.
                        </p>
                        <br>
                        <p></p>
                    </div>
    ...
    <div class="mb-60"></div>
    <section id="invited" class="wow fadeInUp Invisivel">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h3>Convidados</h3>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h3>Edições</h3>
                    <div class="title-separator mb-60"></div>
                    <a href="../../Componentes/edicoes/2017.html" target="_blank">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="blog-card col-md-4 wow bounceIn" data-wow-delay="0.25s">
                    <a href="blog/festival-origens-2018-reune-apreciadores-de-charuto-de-diversos-estados-do-brasil.html">
                ...
                <div class="blog-card col-md-4 wow bounceIn" data-wow-delay="0.5s">
                    <a href="blog/festival-origens-leva-participantes-para-fabrica-leite-alves-e-promove-workshop-de-charuto-com-chocolate.html">
                ...
                <div class="blog-card col-md-4 wow bounceIn" data-wow-delay="0.75s">
                    <a href="blog/participantes-do-festival-origens-realizam-roteiro-terra-dannemann-no-reconcavo-da-bahia.html">
                ...
                <div class="col-md-12 text-center">
                    <a href="blog.html" class="btn btn-warning btn-all-posts">Veja mais posts</a>
                </div>
            </div>
        </div>
    </section>
